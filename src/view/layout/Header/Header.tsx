...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-999 flex w-full bg-white text-black drop-shadow-md dark:bg-white dark:text-black">
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          <button
            ...
            className="z-99999 block rounded-sm border border-black bg-white p-1.5 shadow-sm dark:border-black dark:bg-white"
          >
          ...
          <Link
            className="block flex-shrink-0 lg:hidden text-blue-600 font-semibold text-lg"
            to="/"
          >
        ...
        <div className="hidden sm:block">
          <form onSubmit={() => alert("NOT IMPLEMENTED YET!")}>
            <div className="relative">
              <button className="absolute left-0 top-1/2 -translate-y-1/2 text-blue-600">
                <Search size={18} />
              </button>
