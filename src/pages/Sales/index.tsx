    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-text-secondary mt-1">Gerencie todas as transações do sistema</p>
        </div>
      </div>
        ...
        {transactions.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-16">
            ...
            <p className="text-text-secondary text-center max-w-md mb-6">
              {(filters.transactionId || filters.status !== 'all' || filters.paymentMethod !== 'all' || filters.dateRange) 
                ? 'Nenhuma transação corresponde aos filtros selecionados. Tente ajustar seus filtros.'
