...
import { Eye, Edit, ToggleLeft, ToggleRight, Calendar, Tag, Percent, DollarSign } from 'lucide-react';
        ...
        >
          ...
          <div className="space-y-3 mb-4">
            <div className="flex justify-between items-center">
              ...
              <span className={`font-medium ${coupon.discountType === 'percentage' ? 'text-emerald-500' : 'text-blue-500'}`}>
                {coupon.discountType === 'percentage' 
